...
Этот сервер был написан для сайта.
Его основная задача
1.Конвектировать структуру от сайта в OrderRequest(iiko.biz) и отправить на проверку 
2.Полученный ответ конвертировать в структуру для сайта 
...
####  Как использовать     
 ...
 - В /service/products  и  /service/setting реализуйте свои методы в зависимости от своей структуры в БД  
